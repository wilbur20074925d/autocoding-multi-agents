...
**Examples (`monitoring-give`):** “We have one more question.”, “I can show you task two.” — **next part / remaining work**, not **evaluating** output quality and not **Cognitive.concept_exploration** unless the line is mainly definitional content.
...
## Critical: not Bloom *level* names

- Phrases like **“The evaluate category includes …”** use **“evaluate”** as the **Bloom level label** (task content / `solution\development-*`), **not** **Metacognitive.evaluating**. Same for listing verbs under **Remember / Understand / … / Create** categories.
